...
function clearData() {
    ...
    for (var i=0; i<clr.length; i++) {
        console.log("clearData ",clr[i].id);
        clr[i].innerText = "";
    }
...
function readSessionStorage() {
    ...
    console.log("readSessionStorage ",sessionStorage.publicId,usingPresetVideo);
}
...
function updateProgress() {
	...
	console.log("calling updateProgress cycle",autoTagProgress,transcriptProgress,rate/1000,originalDuration);
...
function getVideoFormat() {
    ...
    if(usingPresetVideo) {
        console.log("getVideoFormat for preset video",videosFormatState);
...
function constructTranscodePlayers() {
    console.log("constructTranscodePlayers");
...
function constructAIPlayers() {
    console.log("constructAIPlayers");
